...
<div class="tx-mwimagemap-pi1">
    <div id="mainBanner_oneColumn" class="border mb">
        <ul id="bannerList">
            ...
            <li>
                <img src="<?php echo base_url('upload/slide/'.$slide_list->image_link)?>" class="img-responsive" width="860" height="300" id="tx_mwimagemap_img_1" usemap="#map_1" alt="DWK- Duran Wheaton Kimble"/>
            </li>
            <?php endforeach;?>
        </ul>
    </div>
