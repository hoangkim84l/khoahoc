...
Class Recruitment extends MY_Controller
{
    ...
    function index()
    {
        ...
        $total_rows = $this->recruitment_model->get_total();
        ...
        $config['base_url']   = admin_url('recruitment/index'); //link hien thi ra danh sach bài viết
    ...
    function edit()
    {
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                //them moi vao csdl
                if($this->recruitment_model->update($recruitment->id, $data))
                {
                    //tạo ra nội dung thông báo
