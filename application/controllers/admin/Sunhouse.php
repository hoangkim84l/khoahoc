...
Class Sunhouse extends MY_Controller
{
    ...
    function index()
    {
        ...
        $config['base_url']   = admin_url('sunhouse/index'); //link hien thi ra danh sach bài viết
        ...
        $list = $this->sunhouse_model->get_list($input);
        $this->data['list'] = $list;
        ...
        //load view
        $this->data['temp'] = 'admin/sunhouse/index';
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
               ...
               $name = $this->input->post('title');
                ...
                //them moi vao csdl
                if($this->sunhouse_model->create($data))
                {
                ...
                redirect(admin_url('sunhouse'));
            }
        }
        
        
        //load view
        $this->data['temp'] = 'admin/sunhouse/add';
        $this->load->view('admin/main', $this->data);
    }
    ...
    function edit()
    {
        ...
        $sunhouse = $this->sunhouse_model->get_info($id);
        if(!$sunhouse)
        {
            //tạo ra nội dung thông báo
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                //them moi vao csdl
                if($this->sunhouse_model->update($sunhouse->id, $data))
                {
                    //tạo ra nội dung thông báo
        ...
        //load view
        $this->data['temp'] = 'admin/sunhouse/edit';
        $this->load->view('admin/main', $this->data);
    }
    ...
    private function _del($id)
    {
        ...
        $this->sunhouse_model->delete($id);
        //xoa cac anh cua bài viết
        $image_link = './upload/sunhouse/'.$sunhouse->image_link;
