...
Class Project extends MY_Controller
{
    ...
    function index()
    {
        ...
        $total_rows = $this->project_model->get_total();
        ...
        $config['base_url']   = admin_url('project/index'); //link hien thi ra danh sach bài viết
    ...
    function edit()
    {
        ...
        $project = $this->project_model->get_info($id);
        if(!$project)
        {
            //tạo ra nội dung thông báo
        ...
        if($this->input->post())
        {
            ...
            if($this->form_validation->run())
            {
                ...
                //them moi vao csdl
                if($this->project_model->update($project->id, $data))
                {
                    //tạo ra nội dung thông báo
    ...
    private function _del($id)
    {
        ...
        $image_link = './upload/project/'.$project->image_link;
