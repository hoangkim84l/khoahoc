  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pull-left">
        <div class="page-in-name"><span>Kết quả tìm kiếm với từ khóa "<?php echo $key?>"</span></div>
      </div>
      <div class="col-lg-6 pull-right">
        <div class="page-in-bread"><span>Bạn đang ở đây:</span> <a href="<?php echo base_url()?>">Trang chủ</a> \ Tìm kiếm sản phẩm</div>
      </div>
    </div>
  </div>
</div>
