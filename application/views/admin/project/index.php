	...
	<div class="widget">
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
			...
			<thead class="filter"><tr><td colspan="6">
				<form method="get" action="<?php echo admin_url('project')?>" class="list_filter form">
					<table width="80%" cellspacing="0" cellpadding="0"><tbody>
						...
						<tr>
							...
							<input type="reset" onclick="window.location.href = '<?php echo admin_url('project')?>'; " value="Reset" class="basic">
							</td>
			...
			<tbody class="list_item">
			     ...
			     <tr class="row_<?php echo $row->id?>">
					...
					<div class="image_thumb">
						<img height="50" src="<?php echo base_url('upload/project/'.$row->image_link)?>">
						<div class="clear"></div>
					</div>
					...
					<td class="option textC">
						<a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('project/edit/'.$row->id)?>">
							<img src="<?php echo public_url('admin/images')?>/icons/color/edit.png">
						</a>
						
						<a class="tipS verify_action" title="Xóa" href="<?php echo admin_url('project/del/'.$row->id)?>">
