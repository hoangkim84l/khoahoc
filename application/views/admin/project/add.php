...
<div class="wrapper">
   <!-- Form -->
   <form enctype="multipart/form-data" method="post" action="<?php echo admin_url('project/add')?>" id="form" class="form">
      <fieldset>
         <div class="widget">
            <div class="title">
            ...
            <div class="tab_container">
               <div class="tab_content pd0" id="tab1" style="display: block;">
                  ...
                  <div class="formRow">
                    ...
                    <div class="formRight">
                        <span class="oneFour"><input type="radio" name="is_home" value="0"> Có <br/>  
                        <input type="radio" name="is_home" value="1"> Không</span>		<span class="autocheck" name="warranty_autocheck"></span>		
