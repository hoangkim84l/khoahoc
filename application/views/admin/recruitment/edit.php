<!-- head -->
<?php $this->load->view('admin/recruitment/head', $this->data)?>
<div class="line"></div>
<div class="wrapper">
   <!-- Form -->
            ...
            <div class="tab_container">
               <div class="tab_content pd0" id="tab1" style="display: block;">
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <span class="oneTwo"><input type="text" _autocheck="true" id="param_title" value="<?php echo $recruitment->name?>" name="title"></span>
               ...
               <div class="tab_content pd0" id="tab2" style="display: none;">
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_meta_desc" name="meta_desc"><?php echo $recruitment->meta_desc?></textarea></span>
                  ...
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_meta_key" name="meta_key"><?php echo $recruitment->meta_key?></textarea></span>
               ...
               <div class="tab_content pd0" id="tab3" style="display: none;">
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <textarea class="editor" id="param_content" name="content"><?php echo $recruitment->info?></textarea>
